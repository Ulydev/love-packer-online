...
var PACKAGE_NAME = "/upload/1px-fXzlY/game.data";
var REMOTE_PACKAGE_BASE = "/upload/1px-fXzlY/game.data";
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_/Users/ulysse/Desktop/love-packer/.uploads/games/1px-fXzlY/game.data');

    };
    Module['addRunDependency']('datafile_/Users/ulysse/Desktop/love-packer/.uploads/games/1px-fXzlY/game.data');
