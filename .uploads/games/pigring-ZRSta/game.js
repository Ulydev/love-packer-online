...
var PACKAGE_NAME = "/upload/pigring-ZRSta/game.data";
var REMOTE_PACKAGE_BASE = "/upload/pigring-ZRSta/game.data";
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_/Users/ulysse/Desktop/love-packer/.uploads/games/pigring-ZRSta/game.data');

    };
    Module['addRunDependency']('datafile_/Users/ulysse/Desktop/love-packer/.uploads/games/pigring-ZRSta/game.data');
